            ...
            <section class="content">
                ...
                <div class="box box-solid">
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-12">
                                <a href="<?php echo base_url();?>mantenimiento/usuarios/add" class="btn btn-prymary btn-flat"><span class="fa fa-plus"></span>Agregar Nuevo Estudiante</a>
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                                        ...
                                        <tr>
                                           ...
                                           <!--<td><?php echo $usr->password;?></td>-->
                                            ...
                                            <div class="btn-group">                               
                                                    ...
                                                    <a href="<?php echo base_url()?>mantenimiento/usuarios/edit/<?php echo $usr->id;?>" class="btn btn-warning"><span 
                                                    class="fa fa-pencil"></span></a>

                                                    <a href="<?php echo base_url();?>mantenimiento/usuarios/delete/<?php echo $usr->id;?>" class="btn btn-danger btn-remove"><span class="fa fa-remove"></span></a>
                                                </div>
                                            </td>
                                        </tr>
                                            <?php endforeach?>
