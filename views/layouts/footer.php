...
$(document).ready(function () {
    ...
    $(".btn-remove").on("click", function(e){
        ...
        $.ajax({
            ...
            success:function(resp){
                //http://localhost/ventas_ci/mantenimiento/libros
                // esta estructura se encarga de borrar y actualizar cuando se elimana un registro para ello mandamos a llamar al metodo btn-remove
    ...
    $(".btn-view").on("click", function(){
        var id = $(this).val();
        $.ajax({
            url: base_url + "mantenimiento/libros/view/" + id,
            type:"POST",
            success:function(resp){
                $("#modal-default .modal-body").html(resp);
                //alert(resp);
                //esta estructura se encarga de mostrar los datos cuando querramos ver un registro especifico esta funcion hace la validacion 
            }
    ...
    $(".btn-view-usuarios").on("click", function(){
        var id = $(this).val();
        $.ajax({
            url: base_url + "mantenimiento/estudiantes/view/"+ id,
            type:"POST",
            success:function(resp){
                $("#modal-defaul .modal-body").html(resp);
            }
        });
    });
    $(".btn-view-prestamo").on("click", function(){
        var id = $(this).val();
        $.ajax({
            url: base_url + "mantenimiento/prestamos/view/"+ id,
            type:"POST",
            success:function(resp){
                $("#modal-defaul .modal-body").html(resp);
            }
